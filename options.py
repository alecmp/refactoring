...
# Dataset
################
parser.add_argument('--dataset_code', type=str, default='amazon-reviews', choices=DATASETS.keys())
...
parser.add_argument('--eval_set_size', type=int, default=500, 
                    help='Size of val and test set. 500 for ML-1m and 10000 for amazon-reviews recommended')
################
# Dataloader
################
